...
import { TradePanel } from "../flow/trade-panel";
 ...
 *  range product line — alongside the trade ticket that turns the model-fair
 *  read into a real on-chain mint/redeem. */
export function FlowEdgeGrid() {
  return (
    <div className="grid min-h-0 flex-1 grid-cols-1 gap-px bg-hairline lg:grid-cols-[1fr_minmax(320px,360px)]">
      <div className="grid min-h-0 grid-cols-1 gap-px bg-hairline lg:grid-cols-[1.2fr_1fr] lg:grid-rows-2">
      ...
      <TradePanel className="min-h-[560px] lg:min-h-0" />
    </div>
  );
}
