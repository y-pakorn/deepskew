...
export function SmileChart({ pts }: { pts: { k: number; iv: number }[] }) {
  ...
  return (
    ...
    >
      ...
      {hover ? (
        <div
          className="pointer-events-none absolute top-3 z-10 -translate-x-1/2 rounded border border-hairline bg-panel-elev px-1.5 py-0.5 text-val whitespace-nowrap tabular"
